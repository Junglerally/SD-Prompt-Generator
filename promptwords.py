prompts = {
    ...
    "settings": {
        ...
        "all": [
            'street', 'beach', 'mountainous landscape', 'landscape', 'lake', 'city', 'river', 'valley', 'house near a lake',
            'house', 'the beach', 'skyscrapers', 'nature', 'town', 'forest', 'swamp', 'urban landscape', 'natural landscape',
            'alien landscape', 'city streets', 'town streets', 'liminal space', 'abandoned building', 'fort', 'thunderstorm',
            'snowstorm', 'nature park', 'battlefield', 'castle', 'detailed background', 'epic sky', 'kitchen', 'bedroom',
            'living room', 'office', 'throne room', 'cockpit', 'fireplace', 'cargo bay', 'dock', 'meadow', 'stream', 'cave',
            'stadium', 'alleyway', 'market', 'theater', 'workshop', 'field', 'farm', 'barn', 'path', 'jungle', 'pond', 'highway',
            ...
            'Library of Alexandria', 'pyramids', 'shop', 'suburb', 'waterfall', 'pier', 'fountain', 'volcanic landscape',
            'laboratory', 'haunted house', 'prison', 'factory', 'canyon', 'church', 'colosseum', 'roller coaster', 'palace',
            'bridge', 'tundra', 'aquarium', 'hallway', 'military base', 'cityscape', 'sea', 'ocean', 'navy', 'street market',
            'space station in outer space', 'mothership', 'planetary ring in outer space', 'nebula', 'supernova remnant',
            'irregular galaxy', 'black hole', 'star system in outer space','binary star system in outer space',
            'fleet starships in outer space', 'orbital elevator', 'dyson sphere',
            'ring planet in outer space','wormhole in outer space','alien planet in outer space', 'exoplanet in outer space',
            'asteroid', 'Orion Nebula', 'galaxy', 'exotic star in outer space', 'artificial landscape',
            'alien megastructure', 'alien megastructure in outer space', 'battle bombardment', 'dwarven keep', 'elf hideout'],
