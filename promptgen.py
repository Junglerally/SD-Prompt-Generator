...
#Sea object settings and object relations are combined for sake of making sense in output. Feel free to change this if you wish.
            ...
            "sea": ['in a stormy ocean', 'underwater', 'in the high seas', 'in a large river', 'docked at port', 'in battle at sea', 'outside of an island', 'on the water near land', 'in the Arctic Ocean', 'in the Caribbean Sea', 'in a naval battle', 'in a large lake'],
